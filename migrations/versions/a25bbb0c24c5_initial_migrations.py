...
Revision ID: a25bbb0c24c5
Revises: 
Create Date: 2023-06-06 17:45:11.383769
...
def upgrade():
    ...
    op.create_table('function_with_department',
    ...
    sa.Column('last_login_on', sa.Date(), nullable=True),
    ...
    op.create_table('user_role_dept_mapping',
